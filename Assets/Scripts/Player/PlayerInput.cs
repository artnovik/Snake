...
public class PlayerInput : MonoBehaviour
{
    ...
    private int GetAxisRaw(Axis axis)
    {
        if (axis == Axis.Horizontal)
        {
            ...
            bool leftAButton = Input.GetKeyDown(KeyCode.A);
            bool rightDButton = Input.GetKeyDown(KeyCode.D);

            if (leftArrow || leftAButton)
                return -1;

            if (rightArrow || rightDButton)
                return 1;
        ...
        else if (axis == Axis.Vertical)
        {
            ...
            bool upWButton = Input.GetKeyDown(KeyCode.W);
            bool downSButton = Input.GetKeyDown(KeyCode.S);
